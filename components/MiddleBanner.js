...
const MiddleBanner = () => {
  return (
    <div className="middle-banner md:w-10/12  md:mx-auto  md:flex md:justify-between md:items-center mt-0">
          <div className="left-side mt-0 md:mt-16 pt-40 md:pt-0">
            <div className="discount-button bg-gray-600 rounded-3xl p-2 flex justify-between items-center
                w-80 md:w-96 text-sm font-light">
